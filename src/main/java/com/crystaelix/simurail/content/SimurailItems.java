...
import com.crystaelix.simurail.content.bogey.InvertedPowerlessBogeyBlockItem;
...
public class SimurailItems {
	...
	public static final ItemEntry<InvertedPhysicsBogeyBlockItem> INVERTED_PHYSICS_BOGEY = REGISTRATE.
			...
			register();
	public static final ItemEntry<InvertedPowerlessBogeyBlockItem> INVERTED_POWERLESS_BOGEY = REGISTRATE.
			item("inverted_powerless_bogey", InvertedPowerlessBogeyBlockItem::new).
			register();
