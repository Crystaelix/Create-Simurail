...
public class SimurailCompatConfig extends SimurailBaseConfig {
	...
	public final ConfigFloat monorailLateralMaxSpeedFactor = f(500, 0, Short.MAX_VALUE, "lateralMaxSpeedFactor", Units.acceleration, Comments.monorailLateralMaxSpeedFactor);
	public final ConfigFloat monorailVerticalMaxSpeedFactor = f(100, 0, Short.MAX_VALUE, "verticalMaxSpeedFactor", Units.acceleration, Comments.monorailVerticalMaxSpeedFactor);
	public final ConfigFloat monorailAdhesionFactor = f(24, 0, Short.MAX_VALUE, "adhesionFactor", Units.acceleration, Comments.monorailAdhesionFactor);

	public final ConfigGroup narrow = group(2, "narrow", "Narrow");
	public final ConfigFloat narrowLateralMaxSpeedFactor = f(25, 0, Short.MAX_VALUE, "lateralMaxSpeedFactor", Units.acceleration, Comments.narrowLateralMaxSpeedFactor);
	public final ConfigFloat narrowVerticalMaxSpeedFactor = f(50, 0, Short.MAX_VALUE, "verticalMaxSpeedFactor", Units.acceleration, Comments.narrowVerticalMaxSpeedFactor);
	public final ConfigFloat narrowAdhesionFactor = f(12, 0, Short.MAX_VALUE, "adhesionFactor", Units.acceleration, Comments.narrowAdhesionFactor);

	public final ConfigGroup wide = group(2, "wide", "Wide");
	public final ConfigFloat wideLateralMaxSpeedFactor = f(50, 0, Short.MAX_VALUE, "lateralMaxSpeedFactor", Units.acceleration, Comments.wideLateralMaxSpeedFactor);
	public final ConfigFloat wideVerticalMaxSpeedFactor = f(50, 0, Short.MAX_VALUE, "lateralMaxSpeedFactor", Units.acceleration, Comments.wideVerticalMaxSpeedFactor);
	public final ConfigFloat wideAdhesionFactor = f(12, 0, Short.MAX_VALUE, "adhesionFactor", Units.acceleration, Comments.wideAdhesionFactor);
