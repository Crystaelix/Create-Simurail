...
public class SimurailBlocksConfig extends SimurailBaseConfig {
	...
	public final ConfigGroup gangway = group(1, "gangway", "Gangways");
	public final ConfigBool gangwayAllowManualDisconnection = b(true, "allowManualDisconnection", Comments.gangwayAllowManualDisconnection);
	...
	static class Comments {
		...
		static String gangwayAllowManualDisconnection = "Allow players to disconnect gangways by clicking them with an empty hand.";
