...
public class SimurailClientConfig extends SimurailBaseConfig {
	...
	public final ConfigBool wheelSlipSparks = b(true, "enabled", Comments.wheelSlipSparks);
	...
	static class Comments {
		static String wheelSlipSparks = "Spawn sparks between the wheels of a Physics Bogie and the track when the wheels lose traction.";
