...
import com.crystaelix.simurail.content.bogey.InvertedUnpoweredPhysicsBogeyBlockItem;
...
public class SimurailItems {
	...
	public static final ItemEntry<InvertedPhysicsBogeyBlockItem> INVERTED_PHYSICS_BOGEY = REGISTRATE.
			...
			register();
	public static final ItemEntry<InvertedUnpoweredPhysicsBogeyBlockItem> INVERTED_UNPOWERED_PHYSICS_BOGEY = REGISTRATE.
			item("inverted_unpowered_physics_bogey", InvertedUnpoweredPhysicsBogeyBlockItem::new).
			register();
