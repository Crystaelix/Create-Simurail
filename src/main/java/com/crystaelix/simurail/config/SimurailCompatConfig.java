...
public class SimurailCompatConfig extends SimurailBaseConfig {
	...
	public final ConfigFloat monorailAdhesionFactor = f(24, 0, Float.MAX_VALUE, "adhesionFactor", Units.acceleration, Comments.monorailAdhesionFactor);
	...
	public final ConfigFloat narrowAdhesionFactor = f(12, 0, Float.MAX_VALUE, "adhesionFactor", Units.acceleration, Comments.narrowAdhesionFactor);
	...
	public final ConfigFloat wideAdhesionFactor = f(12, 0, Float.MAX_VALUE, "adhesionFactor", Units.acceleration, Comments.wideAdhesionFactor);
